...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="border border-success">            
            ...
            <asp:TextBox ID="txt_CNPJ" runat="server" Width="293px" Enabled="False"></asp:TextBox>
            &nbsp;&nbsp;<asp:Label ID="Label2" runat="server" Text="I.E."></asp:Label>
            <asp:TextBox ID="txt_IE" runat="server" Width="290px" Enabled="False"></asp:TextBox>
            ...
            <asp:TextBox ID="txt_Numero" runat="server" Width="260px" Enabled="False"></asp:TextBox>
            <br />
            <br />
            ...
            <asp:TextBox ID="txt_Total" runat="server" Enabled="False" Width="362px"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label9" runat="server" Text="OBSERVAÇÃO."></asp:Label>
            <asp:TextBox ID="txt_obs" runat="server" Width="1180px"></asp:TextBox>
